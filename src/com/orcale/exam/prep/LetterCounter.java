...
// Another way find duplicate using set
// using map to find duplicate char 
public class LetterCounter {
    ...
    public static void main(String []args)
    {
        ...
        Map<String,Integer> letterMap = counter.CountLetter("Java, is the most most used object oriented language ravindra");
